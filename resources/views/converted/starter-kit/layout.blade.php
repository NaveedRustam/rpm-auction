...
<html
    ...
    <head>
        ...
        <meta name="description" content="@yield('description', 'Converted starter kit page')" />
            ...
            <div class="layout-container">
                <aside id="layout-menu" class="layout-menu menu-vertical menu">
                    <div class="app-brand demo">
                        <a href="{{ route('starter-kit.page-1') }}" class="app-brand-link">
                    ...
                    <ul class="menu-inner py-1">
                        <li class="menu-item {{ $activePage === 'page-1' ? 'active' : '' }}">
                            <a href="{{ route('starter-kit.page-1') }}" class="menu-link">
                                <i class="menu-icon icon-base ti tabler-smart-home"></i>
                                <div>Page 1</div>
                            </a>
                        </li>
                        <li class="menu-item {{ $activePage === 'page-2' ? 'active' : '' }}">
                            <a href="{{ route('starter-kit.page-2') }}" class="menu-link">
                        ...
                        <footer class="content-footer footer bg-footer-theme">
                            <div class="container-xxl">
                                <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
                                    <div class="text-body">
                                        &copy; {{ now()->year }}, made with love by
