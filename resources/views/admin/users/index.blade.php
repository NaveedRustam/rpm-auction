            ...
            dataTable = $('#role-datatable').DataTable({
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                '<a href="javascript:;" class="btn btn-sm btn-icon item-edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" onclick="editUser('+full.id+')"><i class="text-primary fa fa-pencil"></i></a>'
                            );
                        }
                    },
                    {
