    ...
    <script>
        ...
        $(document).ready(function() {
            dataTable = $('#role-datatable').DataTable({
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            full.name +
                            '`)"><i class="text-primary fa fa-pencil"></i></a>' +
                                '<a href="javascript:;" class="btn btn-sm btn-icon item-edit" onclick="deletePermission('+full.id+')"><i class="text-danger fa fa-trash"></i></a>'
                            );
                        }
                    },
                    {
                ...
                displayLength: 7,
                lengthMeal: [7, 10, 25, 50, 75, 100],
                buttons: [
                    {
                        extend: 'collection',
                        className: 'btn btn-label-primary dropdown-toggle me-2 waves-effect waves-light',
                        text: '<i class="fa fa-file-export me-sm-1"></i> <span class="d-none d-sm-inline-block">Export</span>',
                        buttons: [
                        {
                            extend: 'print',
                    ...
                    {
                        text: '<i class="fa fa-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add New</span>',
                    ...
                    {
                        text: '<i class="fa fa-list me-sm-1"></i> <span class="d-none d-sm-inline-block">Roles</span>',
                        className: 'create-new btn btn-primary waves-effect waves-light ms-1',
