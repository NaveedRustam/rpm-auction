        ...
        $(document).ready(function() {
            dataTable = $('#role-datatable').DataTable({
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            '`)"><i class="text-primary fa fa-pencil"></i></a>' +
                                '<a href="javascript:;" class="btn btn-sm btn-icon item-edit" onclick="deleteRole('+full.id+')"><i class="text-danger fa fa-trash"></i></a>'
                            );
                        }
                    },
                    {
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="fa fa-key me-1"></i> <span class="d-none d-sm-inline-block">Permissions</span>',
