<aside id="layout-menu" class="layout-menu menu-vertical menu">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- User -->
        <li class="menu-item {{ request()->segment(1) == 'roles' || request()->segment(1) == 'permissions' || request()->segment(1) == 'users' ? 'active open' : ''}}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Route::getFacadeRoot()->current()->uri() == 'permissions' ? 'active' : '' }}">
            ...
            {{-- <ul class="menu-sub">
                <li class="menu-item {{ request()->segment(1) == 'lists' ? 'active' : '' }}">
