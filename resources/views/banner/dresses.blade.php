                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12 text-center">
                            <div class="col-md justify-content-start">
                                <img id="modalProductImg" src class="img-fluid rounded w-50 justify-content-start"
                                    alt="Product">
                            </div>
                            <div class="col-md justify-content-end ">
                                <h6 class="mt-2" id="modalProductTitle"></h6>
                                <p>
                                    <span class="text-muted text-decoration-line-through" id="modalOldPrice"></span>
                                    <span class="fw-bold text-danger" id="modalNewPrice"></span>
                                    <span class="badge bg-danger" id="modalDiscount"></span>
                                </p>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-center g-3">
                                <a href="product-details.html" class="text-success fw-bold">View full
                                    details
                                    →</a>
                            </div>
                        </div>
